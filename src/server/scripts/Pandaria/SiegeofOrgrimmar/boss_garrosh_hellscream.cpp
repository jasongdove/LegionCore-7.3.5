...
{
    //Real
    SAY_ENTERCOMBAT                 = 1,//�, ������, ��� �����, ������ ���, ��� ������ ���� ������ ������! 38064
    SAY_HELLSCREAM_WARSONG          = 2,//������ � ������! 38075
    SAY_SUMMON_WOLF_RIDER           = 3,//�������� ���� ����! 38072
    SAY_START_LAUNCH_IRON_STAR      = 4,//������ ���� ������ �������� ����! 38068
    SAY_START_LAUNCH_IRON_STAR2     = 5,//�� ������� ���� ��� ������ � ��������! 38070
    SAY_PHASE_PREPARE               = 6,//�����. ���������. �����! ��� ������ �����, ��� ����� �����! 38048
    SAY_PHASE_REALM_OF_YSHAARJ      = 7,//��... � ����... ����, ����� ������� ���� ���� ���... �� ����� ������� ����... ��� ����! 38051
    SAY_WHIRLING_CORRUPTION         = 8,//� ����� ����! 38076
    SAY_EM_WHIRLING_CORRUPTION      = 9,//���� �� ��� ��������� ��� � ���� ��� ���. 38077
    SAY_LAST_PHASE                  = 10,//�������� ��������� �������� ����. � ����� ���. �� ������� ��� ���� ������� � ���� �����. ���... �����... ����! 38056
    SAY_KILL_PLAYER                 = 11,//�����������! 38065
    SAY_DIE                         = 12,//��� �� �����... ���������... ���... ���... � �� �����... 38046
    SAY_ENTER_REALM_OF_YSHAARJ      = 13,//�� ��������� � ������� ������! 38055
    SAY_HM_LAST_PHASE               = 14,//(����� ������ �������) ������� �� ��������? ������. � ������� ��� �����! 38057
    SAY_MANIFEST_RAGE               = 15,//� �������� ��� ��� ��� ���� ������! 38050
};
